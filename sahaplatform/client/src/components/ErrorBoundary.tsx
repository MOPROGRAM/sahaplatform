  ...
  public render() {
    if (this.state.hasError) {
      return this.props.fallback || (
        <div className="flex flex-col items-center justify-center min-h-[400px] p-6 text-center bg-gray-50 dark:bg-zinc-900 rounded-lg border border-red-100 dark:border-red-900/20">
