...
import NothingStyleBackground from "./LaptopComponentsBackground";
...
export default function PromotedBanner() {
    ...
    return (
        <div className="w-full mt-0.5 mb-1 px-0 sm:px-2 relative group overflow-hidden">
            <NothingStyleBackground />
            <div className="relative w-full z-10">
                <div className="flex items-center gap-2 mb-0.35 px-2 pt-1">
